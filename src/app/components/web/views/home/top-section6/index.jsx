...
class Topsavers extends Component {
    ...
    async componentDidMount() {
        let list = await GroceryStampleDetails.getAllGroceryStaple('milk-products');
        if(list){
                ...
                <section className="product-items-slider section-padding">
                    <div className="container" id="header-category-bk">
                        <div className="section-header">
                            {/* <span>For You</span> */}
                            <h5 className="heading-design-h5">Milk Products {/* <span className="badge badge-primary">20% OFF</span> */}
                                <Link to={{
