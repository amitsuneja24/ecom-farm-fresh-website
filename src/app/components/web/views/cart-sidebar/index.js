                ...
                <div className="cart-sidebar">
                                ...
                                <div className="cart-item" key={index}>
                                    ...
                                    <div className="cart-text">
                                        ...
                                        <div className="qty-group">
                                            ...
                                            <div className="cart-item-price">&#x20B9;{row.qty * row.netPrice}<span>&#x20B9;{row.qty * row.price}</span></div>
                                        </div>
                    ...
                    <div className="cart-sidebar-footer">
                        <div className="cart-store-details">
                            ...
                            <p>Delivery Charges <strong className="float-right text-danger"> &#x20B9;0</strong></p>
                            {/* <h6>Your total savings <strong className="float-right text-danger">&#x20B9;55 (42.31%)</strong></h6> */}
                            <hr />
                        </div>
                        <button disabled={cartItems.length == 0} onClick={() => window.location.href = '/checkout'} className="btn btn-secondary btn-lg btn-block text-left" type="button"><span className="float-left"><i className="mdi mdi-cart-outline" /> Proceed to Checkout </span><span className="float-right"><strong>
                            &#x20B9;{cartItems.reduce((sum, i) => (
                                sum += i.qty * i.netPrice
                            ), 0)}
                        </strong> <span className="mdi mdi-chevron-right" /></span></button>
                    </div>
                </div>
