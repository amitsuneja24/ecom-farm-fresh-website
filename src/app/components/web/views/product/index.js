                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12">
                                <a href="/"><strong><span className="mdi mdi-home" /> Home</strong></a> <span className="mdi mdi-chevron-right" /> <a href="#">Search</a> <span className="mdi mdi-chevron-right" /> <a href="#">Category</a>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-9">
                                <div className="shop-head">
                                    ...
                                    <h5 className="mb-3">Your Search</h5>
                                </div>
