...
const API_URL = "https://serene-tundra-32617.herokuapp.com";
...
const Apis = {
  ...
  GetAllGroceryStaple: `${API_URL}/api/product/getAllGroceryStaple?slug=`,
  GetAllProductList: `${API_URL}/api/product/list/`,

  //product api
  GetOrderCreateByUser: `${API_URL}/api/order/create`,
  GetOrderByUser: `${API_URL}/api/order/listById?id=`,
  ...
  GetProductByFilter: `${API_URL}/api/product/gcatalogsearch/result?slug=`,
